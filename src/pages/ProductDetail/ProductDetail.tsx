...
export default function ProductDetail() {
  ...
  return (
    <div className='bg-gray-200 py-6'>
          ...
          <div className='grid grid-cols-12 gap-9'>
            ...
            <div className='col-span-7'>
              ...
              <div className='mt-8 flex items-center bg-gray-50 px-5 py-4'>
                <div className='text-gray-500 line-through'>aud{formatCurrency(product.price_before_discount)}</div>
                <div className='ml-3 text-3xl font-medium text-orange'>aud{formatCurrency(product.price)}</div>
      ...
      <div className='mt-8'>
        <div className='container'>
          <div className='uppercase text-gray-400'>Related product</div>
          {productsData && (
